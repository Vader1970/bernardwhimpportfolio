...
import { Dialog, DialogTrigger, DialogContent, DialogTitle } from "@relume_io/relume-ui";
...
export const Content10 = ({ image = Content10Defaults.image, video = Content10Defaults.video }: Props) => {
  const [isIframeLoaded, setIsIframeLoaded] = useState<boolean>(false);

  return (
    <section id='relume' className='bg-brand-lightBlack border-b border-white px-[5%] py-16 md:py-24 lg:py-28'>
